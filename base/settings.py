...
SECRET_KEY = '0x8jwk7b%g!t(zuwgyg7t@y$%+0l_%yh+mh=8rjari(f*^q9do'
...
DJANGO_APPS = (
    ...
    'django.contrib.auth',
    # Esta esta nueva para django-allauth
...
SOCIAL_AUTH_FACEBOOK_KEY = '388775722550873'
SOCIAL_AUTH_FACEBOOK_SECRET = 'a1d1f202fc08cd60659b796943ea3b02'
